...
* **Architecture:** x64
* **SHA256 Fingerprint:** `a6dd8f955eb873783b91b71202851f080aeb2467a60743b9dce027bfaacc84d8`
...
| 4 | `SceConfigureConvertedFileSecurity` | `0x2CDD0` | 232 | UnwindData |  |
| 10 | `SceSysPrep` | `0x2D2B0` | 379 | UnwindData |  |
| 11 | `SceSysPrepOffline` | `0x2D440` | 47 | UnwindData |  |
| 27 | `SceDcPromoCreateGPOsInSysvol` | `0x31B10` | 31 | UnwindData |  |
| 28 | `SceDcPromoCreateGPOsInSysvolEx` | `0x31B40` | 775 | UnwindData |  |
| 29 | `SceDcPromoteSecurity` | `0x31E50` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 30 | `SceDcPromoteSecurityEx` | `0x31E70` | 277 | UnwindData |  |
| 31 | `SceEnforceSecurityPolicyPropagation` | `0x31F90` | 16 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 52 | `SceSetupBackupSecurity` | `0x31FA0` | 2,263 | UnwindData |  |
| 53 | `SceSetupConfigureServices` | `0x32880` | 276 | UnwindData |  |
| 54 | `SceSetupGenerateTemplate` | `0x329A0` | 390 | UnwindData |  |
| 55 | `SceSetupMoveSecurityFile` | `0x32B30` | 269 | UnwindData |  |
| 56 | `SceSetupRootSecurity` | `0x32C50` | 2,025 | UnwindData |  |
| 57 | `SceSetupSystemByInfName` | `0x33440` | 1,903 | UnwindData |  |
| 58 | `SceSetupUnwindSecurityFile` | `0x33BC0` | 209 | UnwindData |  |
| 59 | `SceSetupUpdateSecurityFile` | `0x33CA0` | 152 | UnwindData |  |
| 60 | `SceSetupUpdateSecurityKey` | `0x33D40` | 864 | UnwindData |  |
| 61 | `SceSetupUpdateSecurityService` | `0x340B0` | 153 | UnwindData |  |
| 63 | `SceSvcConvertSDToText` | `0x34460` | 20 | UnwindData |  |
| 64 | `SceSvcConvertTextToSD` | `0x34480` | 20 | UnwindData |  |
| 65 | `SceSvcFree` | `0x344A0` | 16 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 67 | `SceSvcQueryInfo` | `0x344B0` | 518 | UnwindData |  |
| 68 | `SceSvcSetInfo` | `0x346C0` | 478 | UnwindData |  |
| 73 | `SceWrapperExportSecurityProfile` | `0x348B0` | 115 | UnwindData |  |
| 74 | `SceWrapperImportSecurityProfile` | `0x34930` | 222 | UnwindData |  |
