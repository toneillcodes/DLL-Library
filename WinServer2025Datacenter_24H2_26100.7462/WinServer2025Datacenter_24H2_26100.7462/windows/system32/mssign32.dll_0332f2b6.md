...
* **Architecture:** x64
* **SHA256 Fingerprint:** `0332f2b60609a8940f724ba52c1cc4b4937488e1505a2b54bcfb700a73addd2c`
...
| 1 | `DllRegisterServer` | `0x2B30` | 77,084 | SectionBoundedDelta | *Size estimated via contiguous RVA delta.* |
| 2 | `DllUnregisterServer` | `0x2B30` | 77,084 | SectionBoundedDelta | *Size estimated via contiguous RVA delta.* |
