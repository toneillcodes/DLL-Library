...
* **Architecture:** x64
* **SHA256 Fingerprint:** `90fd09679380e5555c07fa1446da573cf592d6f12016db58c945ecf29ea3bd67`
...
| 5 | `DllCanUnloadNow` | `0x2B580` | 61 | UnwindData |  |
| 7 | `DllGetClassObject` | `0x2B5D0` | 83 | UnwindData |  |
| 9 | `MFCreate3GPMediaSink` | `0x2B920` | 529 | UnwindData |  |
| 10 | `MFCreateAC3MediaSink` | `0x2BB40` | 515 | UnwindData |  |
| 11 | `MFCreateADTSMediaSink` | `0x2BD50` | 515 | UnwindData |  |
| 12 | `MFCreateASFByteStreamPlugin` | `0x2BF60` | 43 | UnwindData |  |
| 13 | `MFCreateASFContentInfo` | `0x2BFA0` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 15 | `MFCreateASFIndexerByteStream` | `0x2BFC0` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 14 | `MFCreateASFIndexer` | `0x2BFE0` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 17 | `MFCreateASFMediaSinkActivate` | `0x2C000` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 16 | `MFCreateASFMediaSink` | `0x2C020` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 18 | `MFCreateASFMultiplexer` | `0x2C040` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 20 | `MFCreateASFProfileFromPresentationDescriptor` | `0x2C060` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 19 | `MFCreateASFProfile` | `0x2C080` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 21 | `MFCreateASFSplitter` | `0x2C0A0` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 22 | `MFCreateASFStreamSelector` | `0x2C0C0` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 24 | `MFCreateASFStreamingMediaSinkActivate` | `0x2C0E0` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 23 | `MFCreateASFStreamingMediaSink` | `0x2C100` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 29 | `MFCreateByteCacheFile` | `0x2C120` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 30 | `MFCreateCacheManager` | `0x2C140` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 31 | `MFCreateCredentialCache` | `0x2C160` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 34 | `MFCreateDrmNetNDSchemePlugin` | `0x2C180` | 43 | UnwindData |  |
| 36 | `MFCreateFMPEG4MediaSink` | `0x2C1C0` | 529 | UnwindData |  |
| 37 | `MFCreateFileBlockMap` | `0x2C3E0` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 39 | `MFCreateHttpSchemePlugin` | `0x2C400` | 43 | UnwindData |  |
| 40 | `MFCreateLPCMByteStreamPlugin` | `0x2C440` | 43 | UnwindData |  |
| 41 | `MFCreateMP3ByteStreamPlugin` | `0x2C480` | 43 | UnwindData |  |
| 42 | `MFCreateMP3MediaSink` | `0x2C4C0` | 503 | UnwindData |  |
| 43 | `MFCreateMPEG4MediaSink` | `0x2C6C0` | 529 | UnwindData |  |
| 46 | `MFCreateMuxSink` | `0x2C8E0` | 541 | UnwindData |  |
| 47 | `MFCreateNSCByteStreamPlugin` | `0x2CB10` | 43 | UnwindData |  |
| 48 | `MFCreateNetSchemePlugin` | `0x2CB50` | 43 | UnwindData |  |
| 53 | `MFCreatePresentationDescriptorFromASFProfile` | `0x2CB90` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 55 | `MFCreateProxyLocator` | `0x2CBB0` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 57 | `MFCreateSAMIByteStreamPlugin` | `0x2CBD0` | 43 | UnwindData |  |
| 60 | `MFCreateSecureHttpSchemePlugin` | `0x2CC10` | 43 | UnwindData |  |
| 66 | `MFCreateSourceResolver` | `0x2CC50` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 75 | `MFCreateUrlmonSchemePlugin` | `0x2CC70` | 43 | UnwindData |  |
| 84 | `MFGetSupportedMimeTypes` | `0x2CCB0` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 85 | `MFGetSupportedSchemes` | `0x2CCD0` | 5,488 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 6 | `DllGetActivationFactory` | `0x2E240` | 45 | UnwindData |  |
| 77 | `MFCreateVideoRendererActivate` | `0x32A00` | 460 | UnwindData |  |
| 92 | `MFShutdownObject` | `0x32C30` | 252 | UnwindData |  |
| 76 | `MFCreateVideoRenderer` | `0x3B610` | 129 | UnwindData |  |
| 89 | `MFRR_CreateActivate` | `0x40D90` | 14,784 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 56 | `MFCreateRemoteDesktopPlugin` | `0x44750` | 574 | UnwindData |  |
| 54 | `MFCreateProtectedEnvironmentAccess` | `0x45410` | 16 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 88 | `MFLoadSignedLibrary` | `0x45420` | 28 | UnwindData |  |
| 81 | `MFGetLocalId` | `0x45EB0` | 325 | UnwindData |  |
| 86 | `MFGetSystemId` | `0x46960` | 112,876 | SectionBoundedDelta | *Size estimated via contiguous RVA delta.* |
