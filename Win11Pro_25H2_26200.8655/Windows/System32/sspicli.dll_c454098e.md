...
* **Architecture:** x64
* **SHA256 Fingerprint:** `c454098ebdf609879273cc5932ba7620c2276e5dde0b955dcf250ee26b8aa465`
...
| 94 | `SspiEncodeStringsAsAuthIdentity` | `0x1C6D0` | 1,622 | UnwindData |  |
| 97 | `SspiExcludePackage` | `0x1CD30` | 855 | UnwindData |  |
| 103 | `SspiMarshalAuthIdentity` | `0x1D090` | 756 | UnwindData |  |
| 106 | `SspiSetChannelBindingFlags` | `0x1D390` | 335 | UnwindData |  |
| 27 | `GetSecurityUserInfo` | `0x1D4F0` | 16 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 9 | `AddSecurityPackageA` | `0x1D500` | 127 | UnwindData |  |
| 10 | `AddSecurityPackageW` | `0x1D590` | 95 | UnwindData |  |
| 19 | `DeleteSecurityPackageA` | `0x1D600` | 256 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 20 | `DeleteSecurityPackageW` | `0x1D600` | 256 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 95 | `SspiEncryptAuthIdentity` | `0x1D700` | 384 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 99 | `SspiGetComputerNameForSPN` | `0x1D880` | 299 | UnwindData |  |
| 78 | `SecCacheSspiPackages` | `0x1E370` | 1,648 | UnwindData |  |
| 1 | `SecDeleteUserModeContext` | `0x20100` | 113 | UnwindData |  |
| 2 | `SecInitUserModeContext` | `0x20180` | 169 | UnwindData |  |
| 7 | `AddCredentialsA` | `0x203F0` | 314 | UnwindData |  |
| 8 | `AddCredentialsW` | `0x20530` | 314 | UnwindData |  |
| 12 | `ChangeAccountPasswordA` | `0x20670` | 68 | UnwindData |  |
| 13 | `ChangeAccountPasswordW` | `0x206C0` | 68 | UnwindData |  |
| 14 | `CompleteAuthToken` | `0x20710` | 139 | UnwindData |  |
| 22 | `EnumerateSecurityPackagesA` | `0x207B0` | 158 | UnwindData |  |
| 24 | `ExportSecurityContext` | `0x20860` | 173 | UnwindData |  |
| 31 | `ImportSecurityContextA` | `0x20920` | 220 | UnwindData |  |
| 32 | `ImportSecurityContextW` | `0x20A10` | 220 | UnwindData |  |
| 56 | `QueryCredentialsAttributesA` | `0x20B00` | 156 | UnwindData |  |
| 57 | `QueryCredentialsAttributesExA` | `0x20BB0` | 175 | UnwindData |  |
| 61 | `QuerySecurityPackageInfoA` | `0x20C70` | 54 | UnwindData |  |
| 85 | `SetContextAttributesA` | `0x20CB0` | 178 | UnwindData |  |
| 87 | `SetCredentialsAttributesA` | `0x20D70` | 175 | UnwindData |  |
| 88 | `SetCredentialsAttributesW` | `0x20E30` | 175 | UnwindData |  |
| 64 | `SaslAcceptSecurityContext` | `0x218B0` | 600 | UnwindData |  |
| 65 | `SaslEnumerateProfilesA` | `0x21B10` | 16 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 66 | `SaslEnumerateProfilesW` | `0x21B20` | 16 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 67 | `SaslGetContextOption` | `0x21B30` | 318 | UnwindData |  |
| 68 | `SaslGetProfilePackageA` | `0x21C80` | 111 | UnwindData |  |
| 69 | `SaslGetProfilePackageW` | `0x21D00` | 81 | UnwindData |  |
| 70 | `SaslIdentifyPackageA` | `0x21D60` | 48 | UnwindData |  |
| 71 | `SaslIdentifyPackageW` | `0x21DA0` | 48 | UnwindData |  |
| 72 | `SaslInitializeSecurityContextA` | `0x21DE0` | 442 | UnwindData |  |
| 73 | `SaslInitializeSecurityContextW` | `0x21FA0` | 444 | UnwindData |  |
| 74 | `SaslSetContextOption` | `0x22170` | 264 | UnwindData |  |
| 39 | `LsaConnectLocalUser` | `0x22AA0` | 357 | UnwindData |  |
| 49 | `LsaSetMachineCertificate` | `0x22C10` | 354 | UnwindData |  |
