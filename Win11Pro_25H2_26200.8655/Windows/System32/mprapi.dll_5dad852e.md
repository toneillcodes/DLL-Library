...
* **Architecture:** x64
* **SHA256 Fingerprint:** `5dad852e43496730cd937ed6bba57c6a646afcc15f1a8f622888b69588031fa2`
...
| 150 | `MprInfoBlockAdd` | `0x36750` | 683 | UnwindData |  |
| 151 | `MprInfoBlockFind` | `0x36A10` | 144 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 152 | `MprInfoBlockQuerySize` | `0x36AA0` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 153 | `MprInfoBlockRemove` | `0x36AC0` | 643 | UnwindData |  |
| 154 | `MprInfoBlockSet` | `0x36D50` | 893 | UnwindData |  |
| 155 | `MprInfoCreate` | `0x370E0` | 120 | UnwindData |  |
| 156 | `MprInfoDelete` | `0x37160` | 60 | UnwindData |  |
| 157 | `MprInfoDuplicate` | `0x371B0` | 126 | UnwindData |  |
| 158 | `MprInfoRemoveAll` | `0x37240` | 127,212 | SectionBoundedDelta | *Size estimated via contiguous RVA delta.* |
