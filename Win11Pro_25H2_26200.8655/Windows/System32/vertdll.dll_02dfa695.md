...
* **Architecture:** x64
* **SHA256 Fingerprint:** `02dfa695d32113de65a347dd3c9e0e9494dc911eb05963368afc8cc9aebefc8d`
...
| 97 | `NtQueryInformationProcess` | `0x1CCB0` | 11 | UnwindData |  |
| 99 | `NtTerminateProcess` | `0x1CD00` | 11 | UnwindData |  |
| 79 | `InterlockedPopEntrySList` | `0x1CE60` | 52 | UnwindData |  |
| 42 | `ExpInterlockedPopEntrySListResume` | `0x1CE67` | 16 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 41 | `ExpInterlockedPopEntrySListFault` | `0x1CE77` | 9 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 40 | `ExpInterlockedPopEntrySListEnd` | `0x1CE80` | 144 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 81 | `InterlockedPushListSList` | `0x1CF10` | 51 | UnwindData |  |
| 84 | `KiUserExceptionDispatcher` | `0x1CF60` | 65 | UnwindData |  |
| 129 | `RtlEnclaveCallDispatch` | `0x1D010` | 128 | UnwindData |  |
| 130 | `RtlEnclaveCallDispatchReturn` | `0x1D05A` | 70 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 122 | `RtlCallEnclave` | `0x1D0A0` | 207 | UnwindData |  |
| 123 | `RtlCallEnclaveReturn` | `0x1D10B` | 117 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 133 | `RtlGetCurrentProcessorNumberEx` | `0x1D180` | 92 | UnwindData |  |
| 182 | `__chkstk` | `0x1D1F0` | 77 | UnwindData |  |
| 188 | `memcmp` | `0x1D7A0` | 199 | UnwindData |  |
| 189 | `memcpy` | `0x1D8C0` | 682 | UnwindData |  |
| 190 | `memmove` | `0x1D8C0` | 682 | UnwindData |  |
