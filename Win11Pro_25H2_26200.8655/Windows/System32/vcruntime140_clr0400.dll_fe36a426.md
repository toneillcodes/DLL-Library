...
* **Architecture:** x64
* **SHA256 Fingerprint:** `fe36a4265c680988a9b6c7fc840e28a75e7c06642fe5357263d1e519f0e3bd46`
...
| 56 | `_set_purecall_handler` | `0x6C00` | 31,760 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 43 | `__unDName` | `0xE810` | 39 | UnwindData |  |
| 44 | `__unDNameEx` | `0xE840` | 306 | UnwindData |  |
| 10 | `__C_specific_handler_noexcept` | `0xE9D0` | 76 | UnwindData |  |
| 9 | `__C_specific_handler` | `0xEC20` | 523 | UnwindData |  |
| 1 | `_CreateFrameInfo` | `0xF8A0` | 58 | UnwindData |  |
| 3 | `_FindAndUnlinkFrame` | `0xF8E0` | 82 | UnwindData |  |
| 13 | `__CxxFrameHandler` | `0xF990` | 16 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 14 | `__CxxFrameHandler2` | `0xF990` | 16 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 15 | `__CxxFrameHandler3` | `0xF9A0` | 134 | UnwindData |  |
| 33 | `__report_gsfailure` | `0x10070` | 210 | UnwindData |  |
| 30 | `__intrinsic_setjmp` | `0x102F0` | 144 | UnwindData |  |
| 31 | `__intrinsic_setjmpex` | `0x103B0` | 144 | UnwindData |  |
