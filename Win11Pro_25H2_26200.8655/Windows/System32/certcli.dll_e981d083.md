...
* **Architecture:** x64
* **SHA256 Fingerprint:** `e981d08399559c584fad5558bdb2390020f36d07711e59c552332d2f60801922`
...
| 337 | `DllCanUnloadNow` | `0xA360` | 50 | UnwindData |  |
| 338 | `DllGetClassObject` | `0xA3A0` | 120 | UnwindData |  |
| 339 | `DllMain` | `0xA420` | 252 | UnwindData |  |
| 340 | `DllRegisterServer` | `0xA530` | 560 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 341 | `DllUnregisterServer` | `0xA530` | 560 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 491 | `CAGetConfigStringFromUIPicker` | `0xA760` | 126 | UnwindData |  |
| 210 | *Ordinal Only* | `0xE3B0` | 211 | UnwindData |  |
| 221 | *Ordinal Only* | `0x13A00` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 220 | *Ordinal Only* | `0x13A20` | 125 | UnwindData |  |
| 219 | *Ordinal Only* | `0x13AB0` | 136 | UnwindData |  |
| 374 | *Ordinal Only* | `0x13B40` | 16 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 365 | *Ordinal Only* | `0x13B50` | 496 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 241 | *Ordinal Only* | `0x13D40` | 24,384 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 367 | *Ordinal Only* | `0x19C80` | 1,371 | UnwindData |  |
