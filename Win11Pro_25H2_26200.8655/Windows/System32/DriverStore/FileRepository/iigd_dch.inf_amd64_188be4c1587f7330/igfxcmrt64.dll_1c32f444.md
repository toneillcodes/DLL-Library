...
## Binary Metadata
* **Original Path:** `C:\Windows\System32\DriverStore\FileRepository\iigd_dch.inf_amd64_188be4c1587f7330\igfxcmrt64.dll`
* **Architecture:** x64
* **SHA256 Fingerprint:** `1c32f444e447f07725d68948ce23213a595a8f59c1d70477ff9ace14ad74df02`
...
| 14 | `?CreateSampler8x8@CmDevice_RT@@UEAAHAEBUCM_SAMPLER_8X8_DESCR@@AEAPEAVCmSampler8x8@@@Z` | `0x2080` | 193 | UnwindData |  |
| 15 | `?CreateSampler8x8Surface@CmDevice_RT@@UEAAHPEAVCmSurface2D@@AEAPEAVSurfaceIndex@@W4_CM_SAMPLER8x8_SURFACE_@@W4_CM_SURFACE_ADDRESS_CONTROL_MODE_@@@Z` | `0x2150` | 111 | UnwindData |  |
| 16 | `?CreateSampler8x8SurfaceEx@CmDevice_RT@@UEAAHPEAVCmSurface2D@@AEAPEAVSurfaceIndex@@W4_CM_SAMPLER8x8_SURFACE_@@W4_CM_SURFACE_ADDRESS_CONTROL_MODE_@@PEAUCM_FLAG@@@Z` | `0x21C0` | 124 | UnwindData |  |
| 17 | `?CreateSampler@CmDevice_RT@@UEAAHAEBU_CM_SAMPLER_STATE@@AEAPEAVCmSampler@@@Z` | `0x2240` | 123 | UnwindData |  |
| 18 | `?CreateSamplerEx@CmDevice_RT@@UEAAHAEBU_CM_SAMPLER_STATE_EX@@AEAPEAVCmSampler@@@Z` | `0x22C0` | 142 | UnwindData |  |
...
| 79 | `?GetD3DDeviceManager@CmDevice_RT@@UEAAHAEAPEAUIDirect3DDeviceManager9@@@Z` | `0x5A70` | 3,216 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 105 | `CMRT_GetCompleteTime` | `0x6700` | 38 | UnwindData |  |
| 106 | `CMRT_GetEnqueueTime` | `0x6730` | 38 | UnwindData |  |
| 107 | `CMRT_GetHWEndTime` | `0x6760` | 38 | UnwindData |  |
| 108 | `CMRT_GetHWStartTime` | `0x6790` | 36 | UnwindData |  |
| 109 | `CMRT_GetKernelCount` | `0x67C0` | 55 | UnwindData |  |
| 110 | `CMRT_GetKernelName` | `0x6800` | 45 | UnwindData |  |
| 111 | `CMRT_GetKernelThreadSpace` | `0x6830` | 138 | UnwindData |  |
| 112 | `CMRT_GetSubmitTime` | `0x68C0` | 38 | UnwindData |  |
| 116 | `CMRT_SetEventCallback` | `0x68F0` | 38 | UnwindData |  |
| 126 | `CreateCmDevice` | `0x6920` | 115 | UnwindData |  |
| 127 | `CreateCmDeviceEx` | `0x69A0` | 110 | UnwindData |  |
...
| 125 | `CmrtCodeMarkerForGTPin_SetThreadCount` | `0x6FC0` | 86,878 | SectionBoundedDelta | *Size estimated via contiguous RVA delta.* |
