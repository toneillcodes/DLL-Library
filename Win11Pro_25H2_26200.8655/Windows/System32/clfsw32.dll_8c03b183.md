...
* **Architecture:** x64
* **SHA256 Fingerprint:** `8c03b183ad112b78c7915b27f93aa6d979d8f56d444ffcd4fbdd4ec37bcf056c`
...
| 1 | `LsnDecrement` | `0xBFC0` | 14,096 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 29 | `LsnBlockOffset` | `0xF6D0` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 30 | `LsnContainer` | `0xF6F0` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 31 | `LsnCreate` | `0xF710` | 64 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 34 | `LsnIncrement` | `0xF750` | 80 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 35 | `LsnInvalid` | `0xF7A0` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 37 | `LsnNull` | `0xF7C0` | 32 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 38 | `LsnRecordSequence` | `0xF7E0` | 18,432 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 7 | `CLFS_LSN_INVALID` | `0x13FE0` | 40 | ContiguousDelta | *Size estimated via contiguous RVA delta.* |
| 8 | `CLFS_LSN_NULL` | `0x14008` | 0 | Indeterminate |  |
